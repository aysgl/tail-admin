# ⚠️ Config Dokümantasyonu – Önemli Referans

Bu projedeki tüm yapılandırma dosyalarının dokümantasyonu. **Merge conflict yaşamamak için** bu dosyayı ve ilgili config dokümanlarını güncellerken dikkatli olun.
