                    ...
                    >
                      ...
                      <div class="relative">
                        ...
                        <button
                          ...
                          "
                          class="absolute z-30 text-gray-600 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400 bg-transparent border-0 p-0"
                        >
                          <svg
                            v-if="!showPassword"
                            class="fill-current"
                  ...
                  <div>
                    <div>
                      ...
                      >
                        ...
                        <p
                          class="inline-block font-normal text-gray-600 dark:text-gray-400"
                        >
                          By creating an account
                          means you agree to the
                          <span
