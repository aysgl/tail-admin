<template>
  ...
  >
    ...
    <!-- Centered Content -->
    <div
      class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]"
    >
      <h1
    ...
    <!-- Footer -->
    <p
      class="absolute text-sm text-center text-gray-600 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400"
    >
