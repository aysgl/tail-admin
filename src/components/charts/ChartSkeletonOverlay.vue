    ...
    <template v-if="variant === 'bar'">
      <div
        ...
        <USkeleton
          v-for="i in 8"
          :key="i"
          class="flex-1 rounded-t bg-accented"
          :style="{
            height: `${20 + (i % 5) * 15}%`,
            minHeight: '40px',
          }" />
    ...
    <template v-else-if="variant === 'donut'">
      <div
        ...
        <div
          ...
          <div
            class="size-32 animate-pulse rounded-full border-12 border-muted"
            aria-hidden />
          <USkeleton
            class="absolute size-20 rounded-full bg-accented" />
          <USkeleton
            class="absolute h-6 w-12 bg-accented" />
        </div>
        <div class="flex flex-col gap-3">
          <div
            ...
            <USkeleton
              class="size-4 rounded-full bg-accented" />
            <USkeleton
              class="h-4 bg-accented"
              :style="{
                width: `${60 + i * 15}px`,
              }" />
          </div>
