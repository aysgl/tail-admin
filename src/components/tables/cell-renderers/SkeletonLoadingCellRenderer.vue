<template>
  ...
  >
    ...
    <template v-if="type === 'user'">
      <div
        class="size-8 shrink-0 animate-pulse overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700"
      />
      <div
    ...
    <template v-else-if="type === 'team'">
      <div class="flex -space-x-2">
        <div
          v-for="i in 3"
          :key="i"
          class="size-8 animate-pulse rounded-full border-2 border-white bg-gray-200 dark:border-gray-800 dark:bg-gray-700"
        />
      </div>
    </template>
    <!-- Status type: pill -->
    ...
    <template v-else>
      <div
        class="h-4 w-full max-w-[80%] animate-pulse rounded bg-gray-200 dark:bg-gray-700"
      />
    </template>
  </div>
</template>
