      ...
      <table class="min-w-full">
        <thead>
          ...
          >
            <th class="py-3 text-left">
              <p
                class="font-medium text-gray-600 text-theme-xs dark:text-gray-400"
              >
                Products
              </p>
            </th>
        ...
        <tbody>
          ...
          >
            <td class="py-3 whitespace-nowrap">
              ...
              >
                ...
                <div>
                  ...
                  <span
                    class="text-gray-600 text-theme-xs dark:text-gray-400"
                    >{{
                      product.variants
                    }}
                    Variants</span
            ...
            <td class="py-3 whitespace-nowrap">
              <p
                class="text-gray-600 text-theme-sm dark:text-gray-400"
              >
                {{ product.category }}
              </p>
            </td>
