<template>
  ...
  >
    <path
      ...
      fill="currentColor"
    />
    <g filter="url(#filter0_d_logo_icon)">
      <path
    ...
    <g filter="url(#filter1_d_logo_icon)">
      <path
    ...
    <g filter="url(#filter2_d_logo_icon)">
      <path
