<template>
    <div class="mb-10">
        <div
            class="text-title-md text-brand-500 dark:text-brand-400 xl:text-title-lg mb-2 flex flex-wrap justify-center gap-1 font-bold"
        >
            <!-- timer days -->
            <div
