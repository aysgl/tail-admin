    ...
    >
      ...
      >
        <button
          ...
          @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-gray-600 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          :class="[
            isMobileOpen
      ...
      >
        <div
          class="flex items-center gap-2 2xsm:gap-3"
        >
          <ThemeToggler />
          <NotificationMenu />
        </div>
