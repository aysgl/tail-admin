<template>
  ...
  >
    ...
    >
      <span
        class="mr-3 overflow-hidden rounded-full h-11 w-11"
      >
        <img
      ...
      <span
        class="block mr-1 font-medium text-theme-sm"
        >Musharof
      </span>
      ...
      >
        ...
        >
          ...
          >
            ...
            <component
              :is="item.icon"
              class="text-gray-600 group-hover:text-gray-700 dark:group-hover:text-gray-300"
            />
            {{ item.text }}
          </router-link>
        </li>
