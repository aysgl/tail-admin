<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <p
        class="mt-1.5 text-theme-xs text-success-500"
      >
    ...
    <div>
      <label
        for="input-state-disabled"
        class="block text-sm font-medium text-gray-300 dark:text-white/15"
      >
        <span class="mb-1.5 block">Email</span>
        <input
