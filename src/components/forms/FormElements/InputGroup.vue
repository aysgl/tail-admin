  ...
  <div class="space-y-6">
    ...
    <div>
      <label
        ...
        class="block text-sm font-medium text-gray-700 dark:text-gray-400"
      >
        <span class="mb-1.5 block">URL</span>
        <div class="relative">
          <span
    ...
    <div>
      <label
        for="input-group-website"
        class="block text-sm font-medium text-gray-700 dark:text-gray-400"
      >
        <span class="mb-1.5 block">Website</span>
        <div class="relative">
          <button
            @click="copyWebsite"
